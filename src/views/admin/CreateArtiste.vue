  ...
  <main class="mx-6 sm:mx-32 md:mx-44 md:mt-6 lg:mx-64 lg:grid lg:grid-cols-2 lg:gap-40">
    ...
    <form @submit.prevent="createArtiste">
      ...
      <div class="flex flex-row justify-between gap-5">
        <button type="submit" class="w-full bg-gray-900 p-3 font-barlow text-xl font-bold uppercase text-gray-100">Créer</button>
...
export default {
  ...
  methods: {
    ...
    async createArtiste() {
      ...
      const refStorage = ref(storage, "artistes/" + this.artiste.img);
